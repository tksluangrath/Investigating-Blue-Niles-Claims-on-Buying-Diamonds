...
The Simple Linear regression model gives an equation of `Sqrt(Price) = 10.14643 + (57.19923*Carat)
...
- This means carat is a strong predictor of price which supports the claim from blue nile that carat has the biggets impact on price.
The model gives a `R2 value of 0.8959`
