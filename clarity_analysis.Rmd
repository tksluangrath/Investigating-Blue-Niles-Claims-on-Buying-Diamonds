...
<div align="center">
```{r message=FALSE, echo=FALSE, fig.width=6, fig.height=5}
ggplot(clarity_ordered, aes(x = clarity, y = price)) +
  geom_point(alpha = 1.5, aes(color = clarity), size = 1) +
...
ggplot(clarity_ordered, aes(x = clarity, y = price)) +
  ...
  scale_color_manual(values = c("SI2" = "coral", "SI1" = "coral", 
                                "VS2" = "purple", "VS1" = "purple", 
                                "VVS2" = "turquoise","VVS1" = "turquoise", 
                                "IF" = "red", 
                                "FL" = "black")) +
...
This is a zoomed in version of the same scatterplot from above.
