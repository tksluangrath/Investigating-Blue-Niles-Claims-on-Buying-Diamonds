...
```{r cut-bar-plot, fig.width=4,fig.height=3,fig.align="center",echo=FALSE}
...
```{r ACF_plot_tran, message=FALSE, echo=FALSE,fig.width=6, fig.height=4,fig.cap="ACF Residual Model"}
