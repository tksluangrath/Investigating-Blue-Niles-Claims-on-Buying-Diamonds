...
## Color
```{r color-count-plot, message=FALSE, echo=FALSE, fig.width=3, fig.height=2, fig.cap="Distribution of diamond counts by color grade"}
...
```{r color-category-pie-chart, message=FALSE, echo=FALSE, fig.pos = "H", fig.width=3, fig.height=2, fig.cap="Distribution of diamond counts by color groups"}
...
```{r clarity-bar-count, echo=FALSE, fig.width=4, fig.height=2, fig.cap = "Distribution of diamond counts by clarity grade"}
...
```{r clarity-min-max-prices, echo=FALSE, message=FALSE}
...
```{r heatmap-color-clarity-price, echo=FALSE, message=FALSE}
